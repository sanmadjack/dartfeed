...
import 'package:shared/opml/opml.dart' as opml;
import 'package:shared/global.dart';
import 'package:shared/tools.dart';
import 'package:dartfeed/data/data.dart';
import 'package:dartfeed/data_sources/data_sources.dart' as data_source;

class FeedModel {
  static final Logger _log = new Logger('FeedModel');

  final data_source.AGlobalFeedDataSource _globalFeedDataSource;

  FeedModel(this._globalFeedDataSource) {
